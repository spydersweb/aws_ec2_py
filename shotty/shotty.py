...
@click.option('--all', 'list_all', default=False, is_flag=True, help="List all snapshots and not most recent ones")
...
def create_snapshots(project):
    ...
    for i in instances:
        ...
        for v in i.volumes.all():
            ...
            v.create_snapshot(Description="Auto generated snapshot from snappy")
...
@click.option('--project', default=None, help="Only reboot instances for project (tag Project:<name>)")
